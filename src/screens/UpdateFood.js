...
const UpdateFood = ({navigation, route}) => {
  ...
  var foodId=restaurant.id;
  var Foodimage= restaurant.image_url
  var foodname=restaurant.name
  var foodabout=restaurant.about
  var foodprice=restaurant.price
  const [food, setFood] = useState(foodname);
  const [about, setAbout] = useState(foodabout);
